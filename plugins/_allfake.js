...
global.kontak2 = [
[owner[0], await conn.getName(owner[0] + '6285171226069@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'miftahganzz01@gmail.com', true],
[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'miftahganzz01@gmail.com', true],
]
let res = JSON.parse(readFileSync('./package.json'))
global.v = `© ZEX BOTZ V${res.version} (Public Botz)`
global.api = "Zyko"
...
sourceUrl: "https://tiktok.com/@miftahvbotz",
}
}
}
global.fakeig = {
